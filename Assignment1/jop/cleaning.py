...
def misc_cleaning(dataframe):
    ...
    preparedness_df['I have used ChatGPT to help me with some of my study assignments '] = df['I have used ChatGPT to help me with some of my study assignments '].replace(
        {'yes': 1, 'no': 0, 'not willing to say': 0})
...
if __name__ == "__main__":
    ...
    dataframe = bedtime_cleaning(dataframe)
    dataframe = date_cleaning(dataframe)
    dataframe = misc_cleaning((dataframe))
    print(dataframe)
